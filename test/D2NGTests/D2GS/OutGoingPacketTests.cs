...
namespace D2NGTests.D2GS
{
    public class OutGoingPacketTests
    {
        ...
        {
            string str = "655553e25d58010209000000006e6f6d616e636572bbaa6f4b0000004c";
            var gamehash = str.Substring(2, 8);
            var gametoken = str.Substring(10, 4);
            var packet = new GameLogonPacket(BinaryPrimitives.ReverseEndianness(Convert.ToUInt32(gamehash, 16)), BinaryPrimitives.ReverseEndianness(Convert.ToUInt16(gametoken, 16)), new D2NG.MCP.Character("nomancer", "8980ffffffffff09ffffffffff03ffffffffffffffffffffff0180808080ffffff00".HexStringToByteString()));
